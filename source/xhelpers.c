...
int xinerama_screen_geo(xcb_connection_t *xcb, int32_t screen, int32_t *x, int32_t *y, int32_t *w, int32_t *h)
{
	if (!xcb)
		goto fail;
...
int randr_screen_geo(xcb_connection_t *xcb,
                     int32_t           screen,
                     int32_t          *x,
                     int32_t          *y,
                     int32_t          *w,
...
int x11_screen_geo(xcb_connection_t *xcb, int32_t screen, int32_t *w, int32_t *h)
{
	if (!xcb)
		goto fail;
...
xcb_shm_t *xshm_xcb_attach(xcb_connection_t *xcb, const int w, const int h)
{
	...
	xcb_shm_t *shm = malloc(sizeof(xcb_shm_t));
	shm->xcb       = xcb;
