...
namespace godot
{
    ...
    public:
        ...
        Texture2DRDAutoRelease(RenderingDevice::DataFormat format,
                               int cx,
                               int cy,
    ...
    protected:
        ...
        void create_texture(RenderingDevice::DataFormat format, int cx, int cy, bool invert_rb);
        void update_texture(const void *data);
